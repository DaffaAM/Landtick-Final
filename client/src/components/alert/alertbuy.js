    ...
    constructor(props) {
        ...
        handleBuyTiket = async () => {
            ...
            const result2 = await Axios({
                method: "POST",
                url: "http://localhost:3900/api/v1/orderticket",
        ...
        return (
            ...
            >
                    <Container>
                        ...
                        <Row>
                            <Col>
                                <h1 className="name-train">{data.nameTrain}<br/> <i>{data.typetrain.name}</i></h1>
                            </Col>
                        </Row>

                        <Row className="jalan">
                            <Col>
                                <h1 className="jalan-time">{data.startTime}</h1>
                                <i>{this.takeDate(data.createdAt)}</i>
                            </Col>
                            <Col>
                                <h1 className="tujuan">Stasiun {data.startSstation}</h1>
                            </Col>
                        </Row>
                        ...
                        <Row className="jalan">
                            <Col>
                                <h1 className="jalan-time">{data.arrivalTime}</h1>
                                <i>{this.takeDate(data.createdAt)}</i>
                            </Col>
                            <Col>
                                <h1 className="tujuan">Stasiun {data.destinationStation}</h1>
                            </Col>
                        </Row>
                        <Row>
                            <Col>
